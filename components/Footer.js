...
const Footer = () => {
    return (
        <motion.div className='h-100 bg-[url("/dark-study.jpg")] bg-cover bg-center mt-20 flex flex-col justify-between items-center gap-10 '
            initial={{ opacity: 0 }}
        ...
        >
            <div className="top flex justify-center gap-10 md:gap-20 mt-10">
                ...
                >
                    ...
                    <a href="" className="block text-white hover:text-gray-300">Signup</a>
