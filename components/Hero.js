...
const Hero = () => {
    return (
        <section className="Hero relative mt-15 min-h-screen overflow-hidden flex flex-col justify-center items-center">
            <motion.video className="absolute top-0 left-0 w-full h-full object-cover" autoPlay muted loop 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1 }}
            >
                <source src="/study-video.mp4" type="video/mp4" />
            </motion.video>
            ...
            <div className="content relative z-10 flex flex-col items-center gap-10 text-center px-6">
                <motion.div className="text-center tracking-wider"
                    ...
                    <p className="text-lg text-white mb-8">Discover the power of your mind with MindVault - Your Ultimate AI-Powered Study Companion</p>
                    <Link href="/home">
                ...
                <motion.div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 mt-5 text-white max-w-[900px]"
                    ...
                    >
                    <HighlightItem title="Smart Search" content="Using AI" />
                    ...
                    <div className="hidden md:block h-12 w-[2px] bg-white"/>
                    <HighlightItem title="Offline Access" content="Study Anywhere" />
                </motion.div>
            </div>
        </section>
    )
